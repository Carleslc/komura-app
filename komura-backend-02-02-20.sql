...
CREATE TABLE public.members (
    ...
    last_exit timestamp with time zone NOT NULL,
    joined_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT "last seen is updated" CHECK ((last_seen >= last_exit))
);
...
public	online_members	member	object	{"manual_configuration": {"remote_table": "members", "column_mapping": {"user_id": "user_id", "group_id": "group_id"}}}	\N	f
...
3e314dfd-e341-436e-a6c5-cc7fbc3072bd	2020-02-02 21:49:45.744763+00
\.
...
ALTER TABLE ONLY public.chat_settings
    ADD CONSTRAINT chat_settings_pkey PRIMARY KEY (group_id);
...
ALTER TABLE ONLY public.chat_settings
    ADD CONSTRAINT chat_settings_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_profile_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_personal_space_id_fkey FOREIGN KEY (personal_space_id) REFERENCES public.groups(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
