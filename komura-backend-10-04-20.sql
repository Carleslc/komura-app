...
--
-- Name: user__insert__public__users(); Type: FUNCTION; Schema: hdb_views; Owner: -
--
...
CREATE FUNCTION hdb_views.user__insert__public__users() RETURNS trigger
  ...
  BEGIN
    ...
    IF (((((NEW."id") = (((current_setting('hasura.user')::json->>'x-hasura-user-id'))::text)) OR (((NEW."id") IS NULL) AND ((((current_setting('hasura.user')::json->>'x-hasura-user-id'))::text) IS NULL))) AND ('true')) AND ('true')) THEN
      CASE
...
--
-- Name: delete_member_profile(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_member_profile() RETURNS trigger
    LANGUAGE plpgsql
    AS $$ BEGIN
...
--
-- Name: groups_set_root_path(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.groups_set_root_path() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
	...
	UPDATE groups SET path = regexp_replace(path, OLD.path, new_path, 'q') WHERE root_id = NEW.root_id AND path LIKE (OLD.path || '/%');
	NEW.path := new_path;
...
--
-- Name: user_set_personal_space_private(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_set_personal_space_private() RETURNS trigger
    LANGUAGE plpgsql
    AS $$ BEGIN
...
CREATE TABLE public.users (
    ...
    CONSTRAINT username_max_length CHECK (((length((username)::text) > 0) AND (length((username)::text) <= 32)))
);


--
-- Name: user__insert__public__users; Type: VIEW; Schema: hdb_views; Owner: -
--
...
--
-- Name: user__insert__public__users last_login; Type: DEFAULT; Schema: hdb_views; Owner: -
--

ALTER TABLE ONLY hdb_views.user__insert__public__users ALTER COLUMN last_login SET DEFAULT now();


--
-- Name: user__insert__public__users created_at; Type: DEFAULT; Schema: hdb_views; Owner: -
--

ALTER TABLE ONLY hdb_views.user__insert__public__users ALTER COLUMN created_at SET DEFAULT now();
...
public	users	user	select	{"filter": {}, "columns": ["created_at", "username"], "computed_fields": [], "allow_aggregations": false}	\N	f
public	users	user	insert	{"set": {}, "check": {"id": {"_eq": "X-Hasura-User-Id"}}, "columns": ["email", "id", "username"]}	\N	f
public	users	user	update	{"set": {}, "filter": {"id": {"_eq": "X-Hasura-User-Id"}}, "columns": ["last_login", "username"]}	\N	f
public	users	user	delete	{"filter": {"id": {"_eq": "X-Hasura-User-Id"}}}	\N	f
public	members	user	select	{"filter": {"group": {"members": {"user_id": {"_eq": "X-Hasura-User-Id"}}}}, "columns": ["joined_at", "last_seen", "private_messages", "role"], "computed_fields": [], "allow_aggregations": false}	\N	f
\.
...
public	user_messages	sender	object	{"foreign_key_constraint_on": "sender_id"}	\N	f
public	user_messages	receiver	object	{"foreign_key_constraint_on": "receiver_id"}	\N	f
public	user_messages	message	object	{"foreign_key_constraint_on": "message_id"}	\N	f
public	user_messages	parent	object	{"foreign_key_constraint_on": "parent_id"}	\N	f
public	user_messages	replies	array	{"foreign_key_constraint_on": {"table": "user_messages", "column": "parent_id"}}	\N	f
...
public	member_messages	replies	array	{"foreign_key_constraint_on": {"table": "member_messages", "column": "parent_id"}}	\N	f
public	group_messages	parent	object	{"foreign_key_constraint_on": "parent_id"}	\N	f
public	group_messages	replies	array	{"foreign_key_constraint_on": {"table": "group_messages", "column": "parent_id"}}	\N	f
...
d33384e3-f02d-4e95-95b4-9fb2a16a42e2	2020-04-10 12:30:42.569869+00
\.
...
public	member_roles	{"custom_root_fields": {"delete": null, "insert": null, "select": null, "update": null, "select_by_pk": null, "select_aggregate": null}, "custom_column_names": {}}	f	t
...
public	user_messages	{"custom_root_fields": {"delete": null, "insert": null, "select": null, "update": null, "select_by_pk": null, "select_aggregate": null}, "custom_column_names": {}}	f	f
\.
...
24	UserTest2	user	24	\N	f	24	2020-02-14 11:29:50.414058+00
...
18	A/aa	group	14	14	t	18	2020-02-07 23:43:51.681789+00
14	A	group	14	\N	t	14	2020-02-07 23:40:11.767053+00
20	A/ab	group	14	14	t	20	2020-02-07 23:52:04.383353+00
21	A/aaa	group	14	14	t	21	2020-02-07 23:53:30.300489+00
\.
...
COPY public.member_roles (name) FROM stdin;
owner
admin
member
\.
...
COPY public.members (group_id, user_id, role, profile_id, private_messages, last_seen, last_exit, joined_at) FROM stdin;
4	test-1	owner	4	t	2020-02-05 21:12:05.110466+00	2020-02-05 21:12:05.110466+00	2020-02-05 21:12:05.110466+00
5	test-1	owner	4	t	2020-02-05 21:13:02.918309+00	2020-02-05 21:13:02.918309+00	2020-02-05 21:13:02.918309+00
14	test-1	owner	4	t	2020-02-07 23:40:11.767053+00	2020-02-07 23:40:11.767053+00	2020-02-07 23:40:11.767053+00
20	test-1	owner	4	t	2020-02-07 23:52:04.383353+00	2020-02-07 23:52:04.383353+00	2020-02-07 23:52:04.383353+00
24	test-2	owner	24	t	2020-02-14 11:29:50.414058+00	2020-02-14 11:29:50.414058+00	2020-02-14 11:29:50.414058+00
\.
...
COPY public.profiles (id, name, description, image, banner, is_public, updated_at) FROM stdin;
4	Usuario de prueba	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
5	Test	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
6	Subgroup of Test	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
7	Subgroup 2 of Test	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
14	A	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
18	aa	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
20	a	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
21	aaa	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
24	Usuario de prueba 2	\N	\N	\N	t	2020-02-14 12:31:31.081749+00
\.
...
COPY public.user_messages (message_id, sender_id, receiver_id, read_at, parent_id) FROM stdin;
\.
...
test-2	user2@test.com	UserTest2	2020-02-14 11:29:50.414058+00	2020-02-14 11:29:50.414058+00	24
\.
...
--
-- Name: groups groups_type_path_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_type_path_key UNIQUE (type, path);
...
--
-- Name: member_roles member_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user__insert__public__users user__insert__public__users; Type: TRIGGER; Schema: hdb_views; Owner: -
--
...
--
-- Name: members delete_member_profile; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER delete_member_profile AFTER DELETE ON public.members FOR EACH ROW EXECUTE PROCEDURE public.delete_member_profile();
...
--
-- Name: user_messages delete_message_content; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER delete_message_content AFTER DELETE ON public.user_messages FOR EACH ROW EXECUTE PROCEDURE public.delete_message_content();
...
--
-- Name: groups groups_set_root_path; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER groups_set_root_path BEFORE INSERT ON public.groups FOR EACH ROW EXECUTE PROCEDURE public.groups_set_root_path();
...
--
-- Name: TRIGGER set_profiles_updated_at ON profiles; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TRIGGER set_profiles_updated_at ON public.profiles IS 'trigger to set value of column "updated_at" to current timestamp on row update';
...
CREATE TRIGGER update_group_tree_path BEFORE UPDATE OF path ON public.groups FOR EACH ROW WHEN (((new.path IS DISTINCT FROM old.path) AND (pg_trigger_depth() = 0))) EXECUTE PROCEDURE public.update_group_tree_path();
...
--
-- Name: groups user_set_personal_space_private; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER user_set_personal_space_private BEFORE INSERT ON public.groups FOR EACH ROW WHEN ((new.type = 'user'::text)) EXECUTE PROCEDURE public.user_set_personal_space_private();
...
CREATE TRIGGER user_update_username_path AFTER UPDATE OF username ON public.users FOR EACH ROW WHEN (((new.username IS DISTINCT FROM old.username) AND (pg_trigger_depth() = 0))) EXECUTE PROCEDURE public.user_update_username_path();
...
ALTER TABLE ONLY public.group_messages
    ADD CONSTRAINT group_messages_sender_id_fkey FOREIGN KEY (group_id, sender_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: group_type_indicators group_type_indicators_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.group_type_indicators
    ADD CONSTRAINT group_type_indicators_sender_id_fkey FOREIGN KEY (group_id, sender_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.groups(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: groups groups_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.groups
    ADD CONSTRAINT groups_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: member_messages member_messages_receiver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.member_messages
    ADD CONSTRAINT member_messages_receiver_id_fkey FOREIGN KEY (group_id, receiver_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.member_messages
    ADD CONSTRAINT member_messages_sender_id_fkey FOREIGN KEY (group_id, sender_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: member_type_indicators member_type_indicators_receiver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.member_type_indicators
    ADD CONSTRAINT member_type_indicators_receiver_id_fkey FOREIGN KEY (group_id, receiver_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: member_type_indicators member_type_indicators_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.member_type_indicators
    ADD CONSTRAINT member_type_indicators_sender_id_fkey FOREIGN KEY (group_id, sender_id) REFERENCES public.members(group_id, user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: members members_role_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.members
    ADD CONSTRAINT members_role_fkey FOREIGN KEY (role) REFERENCES public.member_roles(name) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: user_messages user_messages_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_messages
    ADD CONSTRAINT user_messages_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.messages(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: user_messages user_messages_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_messages
    ADD CONSTRAINT user_messages_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.user_messages(message_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: user_messages user_messages_receiver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_messages
    ADD CONSTRAINT user_messages_receiver_id_fkey FOREIGN KEY (receiver_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_messages
    ADD CONSTRAINT user_messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
